...
public class StationLastData {
	...
	public SensorViewModel getSensorViewModel(Double dValue) {
		...
		oSensor.setRefDate(this.refdate);
		oSensor.setShortCode(this.station_code);
		oSensor.setStationId(1);
		oSensor.setValue(dValue.doubleValue());
