...
public class Omirl extends Application {
	...
	public static File lastFileModified(String dir, Date oRefDate) {
		...
		//se � presente una data allora prendiamo il file immediatamente pi� vicino in base ad ora e minuti
		if (oRefDate != null)
		{
			...
			for (File file : aoFiles) {
				...
				try {
					...
					//se per fortuna la differenza � uguale a 0 allora abbiamo trovato il file candidato
					...
					//se la differenza � maggiore di 0 allora � un file precedente alla data
					if (longRefDate - lTicksLastDateFile  > 0)
					{
						//vediamo se � il pi� vicino alla data selezionata
