...
public class ClearThread extends Thread {
	...
	public void run() {
		...
		try {
			...
			System.out.println("AcronetDaemon ClearThread - Start clean operations");
			...
			System.out.println("AcronetDaemon ClearThread - clearing charts");
			...
			for (File oYearFolder : aoYears) {
				...
				try{
					...
					System.out.println("AcronetDaemon Clear Thread: excpetion reading year folder " + oEx.toString());
					oEx.printStackTrace();
				}
				...
				for (File oMonthFolder : aoMonths) {
					...
					try{
						...
						System.out.println("AcronetDaemon Clear Thread: excpetion reading month folder " + oEx.toString());
						oEx.printStackTrace();					
					}				
					...
					for (File oDayFolder : aoDays) {
						...
						try{
							...
							System.out.println("AcronetDaemon Clear Thread: excpetion reading day folder " + oEx.toString());
							oEx.printStackTrace();					
						}				
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////
			System.out.println("AcronetDaemon ClearThread - clearing stations");
			...
			System.out.println("AcronetDaemon ClearThread - clear done");
			
		}
		catch(Exception oEx) {
			System.out.println("AcronetDaemon - Clear Thread Exception");
			oEx.printStackTrace();
		}
